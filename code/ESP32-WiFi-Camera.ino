...
//wifi setting
const char* ssid     = "SRT";                         //wifi name 
const char* password = "12345678";                   // password


//webserver setting 
AsyncWebServer server(80);                          // create the server on port 80 
AsyncWebSocket wsCamera("/Camera");                // to send camera frame to browser  
AsyncWebSocket wsCarInput("/CarInput");           // recive car controll commands 
uint32_t cameraClientId = 0;                     // number id 
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <!-- بخش کنترل ماشین حذف شد -->
      <tr>
        <td colspan="3" style="text-align:center; font-size:30px; font-weight:bold; color:blue;">SRT</td>
      </tr>
      <tr/><tr/>
      <tr>
